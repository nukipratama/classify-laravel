...
class GearSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $gearData = [
            // Row 2
            [
                'type' => GearType::WIRE_SLING->value,
            ...
            // Row 34
            [
                'type' => GearType::MASTERLINK->value,
                'name' => 'Masterlink',
                'swl' => 25.00,
                'qty' => 1,
            ],
            ...
            // Row 39
            [
                'type' => GearType::CHAIN_SLING->value,
            ...
            // Row 43
            [
                'type' => GearType::WEBBING_SLING->value,
                'name' => 'Webbing Red',
                'swl' => 5.00,
                'qty' => 2,
            ],
            // Row 44
            [
                'type' => GearType::WEBBING_ROUND_SLING->value,
            ...
            // Row 77
            [
                'type' => GearType::ACCESORIES->value,
            ...
            // Row 79
            [
                'type' => GearType::PELAT_BESI->value,
                'name' => 'Pelat Besi',
                'swl' => 0.00,
                'qty' => 1,
            ],
            ...
            // Row 82
            [
                'type' => GearType::CHAIN_BLOCK->value,
                'name' => 'Chain Block',
                'swl' => 10.00,
                'qty' => 1,
            ],
